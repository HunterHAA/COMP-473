...
public class FacilityMaintanenceService implements FacilityMaintanenceObserver
{
    ...
    public void update(String usage, Date startTime, int cost, int facilityDownTime, boolean maintenanceStatus)
    {
        ...
        System.out.println("\nHere is the maintanence information: " + "\n" + "\n		The facility is used for " + usage + "\n"
				+ "\n		The facility is using start at: " + startTime + ".\n		The facility downtime is: " + facilityDownTime + ".\n		"
				+ "The facility maintenance status is: " + maintenanceStatus + "\n");
    }
